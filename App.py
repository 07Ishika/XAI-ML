...
# --- App Title ---
st.title("Excel-driven Decision Support App (Charts + ML + LIME)")
...
if uploaded_file is None:
    ...
    st.write("Your Excel file should have one sheet with rows as observations and columns as features. The target variable should be one of the columns.")
